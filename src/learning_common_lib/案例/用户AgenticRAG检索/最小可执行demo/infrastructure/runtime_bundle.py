"""Service composition helpers shared by API, workers, and demo scripts."""
...
try:
    ...
    from .database import build_engine, get_session_factory
    ...
    from 最小可执行demo.infrastructure.database import build_engine, get_session_factory
    from 最小可执行demo.infrastructure.factories import (
        build_checkpoint_manager,
        build_knowledge_projection_port,
        build_llm,
        build_redis_runtime,
    ...
    from 最小可执行demo.ports.knowledge_projection_port import (
...
def build_runtime_bundle(*, use_task_engine: bool = False) -> RuntimeBundle:
    ...
    session_factory = (
        async_sessionmaker(session_engine, expire_on_commit=False)
