...
目录导航:
    ...
    - 当前文件: examples/16_agentic_rag_patterns/03_celery_bridge.py

运行方式:
    - 从项目根目录:
        cd src/learning_common_lib/python基础/langgraph教程
        env LANGGRAPH_STRICT_REDIS=1 uv run python examples/16_agentic_rag_patterns/03_celery_bridge.py
