...
async def main() -> None:
    ...
    b1.add_conditional_edges("work", route, {"fallback": "fallback", "__end__": END})
    ...
    b2.add_conditional_edges("work", route, {"fallback": "fallback", "__end__": END})
    ...
    b3.add_conditional_edges("work", route, {"fallback": "fallback", "__end__": END})
